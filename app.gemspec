...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Danilo"]
  spec.email         = ["danilo.lima@sumup.com"]

  spec.summary       = %q{This apps generates random insults}
  spec.homepage      = "https://github.com/dflima/tty-app"

  # Prevent pushing this gem to RubyGems.org. To allow pushes either set the 'allowed_push_host'
  # to allow pushing to a single host or delete this section to allow pushing to any host.
  if spec.respond_to?(:metadata)
    spec.metadata["homepage_uri"] = spec.homepage
    spec.metadata["source_code_uri"] = "https://github.com/dflima/tty-app"
    spec.metadata["changelog_uri"] = "https://github.com/dflima/tty-app/blob/master/CHANGELOG.md"
  else
